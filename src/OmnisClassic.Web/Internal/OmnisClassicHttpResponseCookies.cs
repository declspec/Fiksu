using Omnis.Web;
using OmnisClassic.Web.Extensions;
using System;
using System.Web;

namespace OmnisClassic.Web.Internal {
    public class OmnisClassicHttpResponseCookies : IHttpResponseCookies {
        private static readonly DateTimeOffset DefaultExpires = DateTimeOffset.UtcNow.AddYears(-10);

        private readonly HttpCookieCollection _cookies;

        public OmnisClassicHttpResponseCookies(HttpCookieCollection cookies) {
